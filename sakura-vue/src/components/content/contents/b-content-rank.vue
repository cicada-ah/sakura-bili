	...
	<div class="rank">
		<div class="b-head">
			<div class="left">
				...
				<ul class="b-slt-tab" v-if="contentId !== 13">
					<li :class="{on: !isOrigin}"  @mouseover="hot">
			...
			<div class="right">
				<div class="b-slt">
					<span class="txt">{{selectedTitle}}</span>
					<ul class="list">
						<li :class="{selected: isSelected1}" @click="selectedItem1">三日</li>
						<li :class="{selected: isSelected2}" @click="selectedItem2">一周</li>
					</ul>
				</div>
			</div>
			<b-content-rank-body 
			:contentId="contentId" 
			:isOrigin="isOrigin" 
			:isWeek="isWeek"></b-content-rank-body>
		</div>
	</div>
</template>

<script>
import BContentRankBody from 'components/content/contents/b-content-rank-body'
export default {
	data() {
		return {
			isSelected1: true,
